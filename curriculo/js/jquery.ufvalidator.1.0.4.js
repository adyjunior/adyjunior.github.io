...
(function($) {
	...
	$.formValidator.defaults = {
		...
		errorDiv		:	'#warn',
		errorMsg		: 	{
								reqString		:	'Please fill the required field(s).',
								reqDate			:	'Date filed is incorrect.',
								reqNum			:	'Only numbers is allowed.',
								reqSelected			:	'Your selects required.',
								reqISSPNotValid	:	'iSSP ID filed is incorrect.',
								reqISSPEmpty	:	'iSSP ID filed is required.',
								reqMailNotValid	:	'E-Mail filed is incorrect.',
								reqMailEmpty	:	'E-mail filed is required.',
								reqSame			:	'Your inputs is mismatch.',
								reqBoth			:	'Both fields is required.',
